...
struct _stmt {
    ...
    union {
        ...
        struct {
            ...
            expr_ty returns;
            string type_comment;
        } AsyncFunctionDef; // await func def
        ...
        struct {
            ...
            asdl_stmt_seq *orelse;
            string type_comment;
        } AsyncFor; // async for item in async_iterator: print(item)
...
struct _expr {
    enum _expr_kind kind;   // express kind
    union {
        struct {
            boolop_ty op;
